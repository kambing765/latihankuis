            ...
            Expanded(child: 
              GridView.builder(
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  childAspectRatio: 0.75, // Rasio lebar dan tinggi untuk item grid
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: Column(
                      children: [
                        Image.asset(
                          foodMenu.imageAsset, // di pubspec harus di bawah flutter yang bukan dependencies                    
                          height: 100,
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(foodMenu.category),      //kategori
                              const SizedBox(height: 5),
                              Text(foodMenu.description),   //deskripsi
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                const SizedBox(height: 20),
                                Text('Bahan-bahan: ${foodMenu.ingredients}'),
                                const SizedBox(height: 5),
                                Text('Waktu masak: ${foodMenu.cookingTime}'),
                                const SizedBox(height: 5),
                                Text('Harga: ${foodMenu.price}')
                              ],)
                            ],
                          ),
                        ),
